...
public class HomeOwner extends AppCompatActivity {
    ...
    public static AlbumsAdapterOwner adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new AlbumsAdapterOwner(this, albumList);

        RecyclerView.LayoutManager mLayoutManager = new GridLayoutManager(this, 1);
        recyclerView.setLayoutManager(mLayoutManager);
        recyclerView.addItemDecoration(new HomeOwner.GridSpacingItemDecoration(2, dpToPx(10), true));
        recyclerView.setItemAnimator(new DefaultItemAnimator());
        recyclerView.setAdapter(adapter);
        findViewById(R.id.but_get_time).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Date calender = Calendar.getInstance().getTime();
                SimpleDateFormat simpleDateFormat = new SimpleDateFormat("HH:mm");
                String time = simpleDateFormat.format(calender);
                updateDate(time);
            }
        });
        getData();
    ...
    private void updateDate(String time) {
        ...
        final ProgressDialog prgDialog1 = new ProgressDialog(HomeOwner.this);
        prgDialog1.setMessage("Sending data..Please wait..");
        ...
        params.add("expt_time", time);

        client.post(URLtoWebsite + "update_expt_time.php", params, new AsyncHttpResponseHandler() {
            @Override
    ...
    private void getData() {
        ...
        client.post(URLtoWebsite + "check_req.php", params, new AsyncHttpResponseHandler() {
            @Override
            public void onSuccess(String response) {
                // Hide ProgressBar
                prgDialog1.hide();
                ...
                try {
                    ...
                    if (arr.length() != 0) {
                        ...
                        for (int i = 0; i < arr.length(); i++) {
                            ...
                            AlbumOwner a = new AlbumOwner(obj.getString("email_id"), obj.getString("photo_url"), obj.getString("pass_name"), obj.getString("mob_no"),
